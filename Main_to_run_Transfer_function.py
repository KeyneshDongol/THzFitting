...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  9 09:48:03 2024
...
from Functions.mainfunction import E_TMM, Error_func,  noise_remove,Error_func2
...
if __name__ == '__main__':
    ...
    '''Transfer function'''
    T_exp_f = E_exp_f/E_air_f
    # T_theo_f = E_theo_f/E_air_f
    ...
    min_func = partial(Error_func2, layers, to_find, omega, eps0, mu, d, E_air_f, T_exp_f,sub_layer,echoes_removed) 
    ...
    if to_find[2] == True:
        ...
        # new_results = tools.save_nk('fitted_data_test3.txt', freq_new,interpolated_data1,interpolated_data2)
        new_results = tools.save_nk('result_data_raw.txt', freq,result[0],result[1])
    ...
    for layer in data['layers']:
        if not layer['is_known']:
            ...
            if isinstance(layer['eps_data'][0], str):
                layer['eps_data'] = ['fitted_data_test3.txt', 'THz']
